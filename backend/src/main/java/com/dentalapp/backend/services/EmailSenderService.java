...
public class EmailSenderService {
    ...
    @Async
    public void sendAppointmentConfirmationEmail(String to, String name, String appointmentDetails, String confirmationLink) {
        try {
    ...
    private String buildAccountConfirmationEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
