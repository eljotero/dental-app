...
public class UpdateAppointmentTimesValidator implements ConstraintValidator<UpdateTimesConstraint, Object> {
    private String startTime;
    private String endTime;

    @Override
    public void initialize(UpdateTimesConstraint constraintAnnotation) {
