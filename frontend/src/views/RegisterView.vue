  ...
  <Card class="card">
    <CardContent>
      ...
      <Form @submit="onSubmit" :validation-schema="formSchema" class="form-container">
        ...
        <StyledSelectFormItem inputName="country" labelFor="country" :label="t('countryLabel')" :labelPlaceholder="t('countryPlaceholder')" :options="countries" errorMessageName="country"/>
        <StyledFormItem inputName="city" inputType="text" :inputPlaceholder="t('cityLabel')" labelFor="city" :labelPlaceholder="t('cityPlaceholder')" :label="t('cityPlaceholder')" errorMessageName="city"/>
